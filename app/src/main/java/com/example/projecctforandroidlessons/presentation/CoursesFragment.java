...
import com.example.projecctforandroidlessons.presentation.ui.EnrollmentAdapter;
import com.example.projecctforandroidlessons.presentation.ui.EnrollmentViewModel;
import com.example.projecctforandroidlessons.data.roomdb.EnrollmentRepositoryImpl;
...
public class CoursesFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // AppDatabase database = AppDatabase.getInstance(requireContext());
        ...
        EnrollmentRepositoryImpl repository = new EnrollmentRepositoryImpl(database.enrollmentDao());
